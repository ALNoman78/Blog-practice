...
const Show_Blog = ({ showBlog , handlerBookmark , handleTime}) => {
    const {id, title, cover, author_img, posted_date, reading_time, author, hashtags } = showBlog
    return (
        <div className='md:mb-20 mb-8'>
            ...
            <div className='my-2'>
                <button className='text-xl font-medium underline text-[rgb(96,71,236)]' onClick={() => handleTime(reading_time ,id)}>Mark as read</button>
            </div>
        </div>
    );
};
